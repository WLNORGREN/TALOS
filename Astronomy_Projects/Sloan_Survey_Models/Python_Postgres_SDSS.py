...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 10 17:22:32 2025
...
# Step 1: Load CSV
csv_file = '~/Documents/python_programs/Astronomy_Datasets/sloan_survey.csv'
...
try:
    ...
    #  Run an SQL query (e.g., select top 10 rows)
    query = f"SELECT  class  FROM {table_name} LIMIT 10;"
    cursor.execute(query)
